...
\begin{theorem}
    ...
    %<*топологическоеопределениенепрерывности>
    $f: X\to Y$ --- непр. на $X \Leftrightarrow \forall G\subset Y$, откр. $f^{-1}(G)$ --- откр. в $X$.
    %</топологическоеопределениенепрерывности>
\end{theorem}
%<*топологическоеопределениенепрерывностиproof>
\begin{proof}
...
\begin{theorem}
    ...
    %<*вейерштрассаонепрерывномобразекомпакта>
    $f:X\to Y$ --- непр. на $X$
...
\begin{theorem}
    ...
    %<*оединственностиасимтотическогоразложения>
    ...
    %</оединственностиасимтотическогоразложения>
\end{theorem}
%<*оединственностиасимтотическогоразложенияproof>
\begin{proof}
    $k:=min\{i:c_i\not=d_i\}$
