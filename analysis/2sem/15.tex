...
\begin{proof}
    ...
    $$=x\lim \underbrace{e^{x\left(1+\frac{1}{2}+\ldots+\frac{1}{n}\right)-x\ln n}}_{e^{\gamma+o(1)}}\prod\limits_{k=1}^{n}\left(1+\frac{x}{k}\right)e^{-\frac{x}{k}}=e^{\gamma x} \prod\limits_{k=1}^{+\infty}\left(1+\frac{x}{k}\right)e^{-\frac{x}{k}}$$
\end{proof}
%</формулавейерштрассаproof>
