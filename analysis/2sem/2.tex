...
\begin{definition}
    Площадь это $\sigma : \mathcal E \to \R_+$, такое что:
    \begin{enumerate}
        \item $A\in \mathcal E \quad A=A_1\sqcup A_2 \quad \sigma A = \sigma A_1 + \sigma A_2$ (конечная аддитивность)
...
\begin{definition}
    ...
    \begin{enumerate}
        \item Монотонна
        \item Нормировка
        \item Ослабленная аддитивность: $E\in \mathcal E \quad E=E_1\cup E_2 \quad E_1\cap E_2$ --- вертикальный отрезок, $E_1$ и $E_2$ лежат каждый в своей полуплоскости относительно этого отрезка $\sigma E=\sigma E_1 + \sigma E_2$
    \end{enumerate}
\end{definition}
