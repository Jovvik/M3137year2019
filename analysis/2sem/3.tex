...
\begin{example}
    ...
    $$=0+\frac{2}{(n-1)!}\left(\frac{\pi^2}{4}-t^2\right)^{n-1}+\sin t\Big|_{-\frac{\pi}{2}}^{\frac{\pi}{2}}+$$
...
\begin{proof}
    ...
    $$H_0 = 2, \quad H_1=\int\limits_{-\frac{\pi}{2}}^{\frac{\pi}{2}}(\frac{\pi^2}{4}-t^2)\cos t = 2\int\limits_{-\frac{\pi}{2}}^{\pi^2} t\sin t dt = 2t(-\cos t)\Big|_{\ldots}^{\ldots}+2\int\limits_{-\frac{\pi}{2}}^{\frac{\pi}{2}} \cos t = 4$$
