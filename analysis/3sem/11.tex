...
\begin{enumerate}
    ...
    \item \(\forall z, w\in \mathbb{C} \ \ \exp(z + w) = \exp z \cdot \exp w\)
\end{enumerate}
%</свойстваэкспоненты>
...
\begin{definition}
    ...
    \begin{itemize}
        \item \(\emptyset\subset \mathcal P\)
...
\begin{example}
    \begin{enumerate}
        ...
        \item \(A = \{1, 2, 3,4,5,6\} \)
              ...
              \begin{enumerate}
                  \item \(\emptyset = X_\sigma, \sigma = \begin{pmatrix} 1 & 1 \\ 1 & 2 \end{pmatrix} \)
...
Свойства:
\begin{enumerate}
    \item \(\emptyset = X\setminus X\in \mathfrak A\)
