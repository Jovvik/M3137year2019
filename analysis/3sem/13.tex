...
\begin{proof}\itemfix
    \begin{enumerate}
        \item [1 \(\Rightarrow\) 2] \(B_k = A_k \setminus A_{k + 1}, A_1 = \bigsqcup B_k \cap A\)
        ...
        \item [2 \(\Rightarrow\) 1] Проверим, что \(C = \bigsqcup C_i \xRightarrow{?} \mu C = \sum \mu C_i\).
              ...
              \[A_1\supset A_2\supset \dots \quad \bigcap A_k = \text{\O} \Rightarrow \mu A_k \xrightarrow{k\to+\infty} 0\]
