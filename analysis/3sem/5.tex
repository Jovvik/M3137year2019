...
\begin{proof}
    ...
    Тогда $f'_y + \lambda \Phi'_y = f'_y - f'_y (\Phi'_y(a))^{-1}\Phi'_y(a) = 0$ и $f'_x + \lambda \Phi'_y = 0$ в силу \eqref{extr_prop}. Итого \eqref{total} выполнено, мы предъявили \(\lambda\), подходящее под искомое.
\end{proof}
