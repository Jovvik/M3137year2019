...
\begin{theorem}[Лебега о мажорированной сходимости для случая сходимости по мере]\itemfix
    %<*лебега1>
    \label{лебега}
    \begin{itemize}
        \item \((X, \mathfrak{A}, \mu)\) --- пространство с мерой
...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item \(\mu X = +\infty\)
              ...
              \[A : = \{x : g_n(x) > 0\}\]
              \[0 \leq \int_X g - \int_X g_n < \varepsilon\]
              \[\int_A g - g_n + \int_{X\setminus A} g = \int_X g - \int_X g_n < \varepsilon \implies \int_{X \setminus A} g < \varepsilon\]
...
\end{corollary}
\begin{proof}
    \[f_n \xRightarrow{\mu} f \xRightarrow[\text{Т. Рисса}]{} \exists (n_k) : f_{n_k} \to f \text{ п.в.}\]
...
\end{corollary}
\begin{proof}
    Возьмём \(g_n\) как в теореме, тогда выполняется неравенство \(\int_X g_n \leq \int_X f_n\). Выберем \((n_k) : \int_X f_{n_k} \xrightarrow{n \to +\infty} \underline\lim \int_X f_n\)
    \[
...
%<*овычисленииинтегралаповзвешенномуобразумерынаблюдение>
\begin{observation}
...
\begin{theorem}[о вычислении интеграла по взвешенному образу меры]\itemfix
    %<*овычисленииинтегралаповзвешенномуобразумеры>
...
%<*овычисленииинтегралаповзвешенномуобразумерыproof>
\begin{proof}
...
%<*овычисленииинтегралаповзвешенномуобразумерыcorollary>
...
\end{corollary}
%</овычисленииинтегралаповзвешенномуобразумерыcorollary>
%<*овычисленииинтегралаповзвешенномуобразумерыcorollaryproof>
\begin{proof}
