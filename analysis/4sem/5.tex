...
\begin{example}[отсутствие плотности]
    ...
    \(\nu\) --- одноточечная мера: \(\nu(A) =\begin{cases}
        1, & 0\in A    \\
        0, & 0\notin A
    \end{cases}\). Тогда \(\nu(\{0\}) = 1\), но \(\int_{\{0\}} \omega d\mu = 0\) --- несостыковка.
...
%<*критерийплотностиproof>
\begin{proof}[Доказательство теоремы~\nameref{критерий плотности}]\itemfix
    \begin{itemize}
        \item [``\( \Rightarrow \)'']
              \[\nu(A) \defeq \int_A \omega(x) d\mu(x)\]
              \[\inf \omega \cdot \mu A = \int_A \inf \omega d\mu \leq \int_A \omega(x) d\mu(x) \leq \int_A \sup \omega d\mu = \sup \omega \cdot \mu A\]
        \item [``\( \Leftarrow \)''] Рассмотрим \(\omega > 0\). Общность не умаляется, т.к. пусть \(e = X(\omega = 0)\), тогда \(\nu(e) \defeq \int_e \omega d\mu = 0\), поэтому в случае \(A\cap e \neq \emptyset\) всё ещё только лучше.
              ...
              Тогда:
              \begin{align*}
                  q\cdot \int_A \omega d\mu & = q \cdot \sum \int_{A_j} \omega d\mu                                    \\
                                            ...
                                            & \symref{по неравенство 21}{\leq} \frac{1}{q} \sum \int_{A_j} \omega d\mu \\
...
\begin{lemma}[о мере образа малых кубических ячеек]\itemfix
    ...
    %</обоценкемеробразовмалыхкубов>
\end{lemma}
%<*обоценкемеробразовмалыхкубовproof>
\begin{proof}
    ...
    \[|x - a| \leq \sqrt{m}h\footnotemark\]
    \footnotetext{Это диагональ куба со стороной \(h\) в \(\R^m\).}
...
%<*мералебегапридиффеоморфизмеproof>
\begin{proof}
    \begin{obozn}\itemfix
        \begin{itemize}
    ...
    \begin{align*}
        ...
        \lambda \Phi(A)                                     & \leq \lambda A \cdot \frac{1}{\inf \frac{1}{|\det \Phi'|}} \\
        \lambda \Phi(A)                                     & \leq \lambda A \cdot \sup |\det \Phi'|                     \\
    \end{align*}
