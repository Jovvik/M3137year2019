...
\begin{definition}
    \(M \subset \R^3\) --- \textbf{кусочн����-гладкое двумерное многообразие}, если \(M\) --- конечное объединение:
    \begin{itemize}
...
\begin{theorem}[формула Стокса]\itemfix
    \begin{itemize}
        \item \(\Omega\) --- просто гладкое двумерное многообразие в \(\R^3\) \textit{(двустороннее)}
...
\begin{proof}
    Ограничимся случаем \(\Omega \subset C^2\). % TODO: что такое C?
