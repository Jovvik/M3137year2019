...
\end{lemma}
\begin{proof}
    $$] p_1(\lambda) : \ker p_1(\varphi) = X, \deg p_1(\lambda) < \deg p_\varphi(\lambda) \Rightarrow p_1(\varphi)\defeq 0 \Rightarrow p_1(\lambda)\in J_\varphi, \deg p_1(\lambda)\subset \deg p_\varphi(\lambda)$$
