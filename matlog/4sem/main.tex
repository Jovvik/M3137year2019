...
\subsection{Модели Кринке}

Идея моделей Кринке следующая: общезначимое утверждение истинно во всех мирах.

\begin{definition}[модели Кринке]\itemfix
    \begin{enumerate}
...
\begin{theorem}
    ИИВ корректно в моделях Кринке.
\end{theorem}
\begin{proof}
