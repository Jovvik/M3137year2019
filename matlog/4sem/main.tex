...
У нас используются следующие правила вывода: % TODO: переписать
\begin{enumerate}
...
\begin{theorem}
    Пусть \((X,\Omega)\) --- топологическое пространство, \(a + b = a\cup b, a\cdot b = a \cap b, a \to b = ((X\setminus a)\subset b)^\circ\), тогда \? % TODO: дописать
\end{theorem}
