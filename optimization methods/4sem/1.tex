...
\begin{figure}[h]
    ...
    \begin{minipage}{0.5\textwidth}
        \centering
        \includesvg[width=.9\linewidth]{\detokenize{images/вырожденная_унимодальная.svg}}
        \caption{Вырожденные \(\alpha\) и \(\beta\), унимодальная функция}
    \end{minipage}%
    \begin{minipage}{0.5\textwidth}
        \centering
        \includesvg[width=.9\linewidth]{\detokenize{images/не_вырожденная_унимодальная.svg}}
