...
\begin{proof}
    ...
    \[\frac{S_n}{n} \rightrightarrows a \Leftrightarrow \varphi_{\frac{S_n}{n}}(t) \to \varphi_a(t) = \E e^{ita} = e^{ita} \quad \forall t \in \R\]
    ...
    \[\varphi_{\xi_1}(t) = 1 + it \E\xi_1 + \smallO(t) = 1 + ita + \smallO(t)\]
...
\begin{theorem}
    ...
    \[ \left| p\left( \frac{S_n - \E\xi_1}{\sqrt{nD\xi_1}} \right) - \Phi_0(x) \right| \le C \frac{\E|\xi_1 - \E\xi_1|^2}{\sqrt{n}(\sqrt{\D\xi_1})^3} \quad \forall x \in \R \]
\end{theorem}
\begin{remark}
    Можно взять \(C = 0.4\)
\end{remark}
